...
module hevc_chroma_reference_line_store8 #(
    ...
    assign top_read_address = (top_candidate_address >= CHROMA_WIDTH) ?
        ADDRESS_WIDTH'(CHROMA_WIDTH - 1) :
