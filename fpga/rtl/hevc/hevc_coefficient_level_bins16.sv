module hevc_coefficient_level_bins16 (
    ...
    typedef enum logic [3:0] {
        ...
        REMAIN_SETUP, RICE_PREFIX, RICE_SUFFIX,
    ...
    wire [4:0] calculated_prefix_ones = normal_rice ?
        normal_rice_quotient : escape_prefix_ones;
    wire [4:0] calculated_suffix_width = normal_rice ?
        {2'd0, rice_parameter} : calculated_escape_length;
    wire [15:0] calculated_suffix_value = normal_rice ?
        remaining_symbol : calculated_escape_value;
